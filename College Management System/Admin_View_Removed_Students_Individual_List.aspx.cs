...
public partial class Admin_View_Removed_Students_Individual_List : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        TextBox85.Text = dr["StdAdmsnCnclnDate"].ToString();
        TextBox86.Text = dr["StdAdmsnCnclnReason"].ToString();
    ...
    {
        Response.Redirect("Admin_View_Removed_Students_Whole_List.aspx");
    }
}