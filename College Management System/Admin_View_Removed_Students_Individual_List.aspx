<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Admin_View_Removed_Students_Individual_List.aspx.cs" Inherits="Admin_View_Removed_Students_Individual_List" %>
...
<title>Student Registration Form</title>&nbsp;<body>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label 
                ID="Label1" runat="server" Text="Removed Student's Details " 
            ...
            <br />
            <br />
            <asp:Panel ID="Panel2" runat="server" CssClass="panel-style" Height="6542px" 
                Width="687px">
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    TargetControlID="Label3">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; s&nbsp;&nbsp;&nbsp;<asp:TextBox 
                    ...
                    PlaceHolder="Enter Your First Name" ReadOnly="True" Width="400px"></asp:TextBox>
                <br />
                ...
                <asp:TextBox ID="TextBox77" runat="server" CssClass="textbox-style" 
                    Height="25px" ontextchanged="TextBox4_TextChanged" ReadOnly="True" 
                    TextMode="Date" Width="400px"></asp:TextBox>
                <br />
                ...
                <asp:TextBox ID="TextBox78" runat="server" CssClass="textbox-style" 
                    Height="25px" PlaceHolder="Enter Your Mobile Number" ReadOnly="True" 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox79" runat="server" 
                    CssClass="textbox-style" Height="25px" PlaceHolder="Enter Your Mobile Number" 
                ...
                <asp:TextBox ID="TextBox81" runat="server" CssClass="textbox-style" 
                    Height="25px" PlaceHolder="Enter State" ReadOnly="True" Width="400px"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                ...
                <asp:Button ID="Button12" runat="server" CssClass="button-style" Height="33px" 
                    onclick="Button12_Click" Text="Go Back to Students' List" Width="220px" />
                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
