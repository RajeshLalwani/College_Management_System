<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Admin_View_Students_Whole_List.aspx.cs" Inherits="Admin_Students_Whole_List" %>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [StdAdmissionID], [StdAdmissionDate], [StdAPassSizePhoto], [StdASalutation], [StdAfname], [StdAmname], [StdAlname] FROM [Student_Details] ORDER BY [StdAdmissionID]">
    </asp:SqlDataSource>
</asp:Content>
