<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Admin_Update_Students_Individual_List.aspx.cs" Inherits="Admin_Update_Students_Individual_List" %>
...
<title>Student Registration Form</title>&nbsp;<body>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label 
                ID="Label1" runat="server" Text="Update Student Details Form" 
            ...
            <br />
            <br />
            <asp:Panel ID="Panel2" runat="server" CssClass="panel-style" Height="7662px" 
                Width="687px">
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    TargetControlID="Label3">
                ...
                <asp:Image ID="Image3" runat="server" Height="200px" ImageAlign="Middle" 
                    Width="200px" />
                <br />
                <asp:Label ID="Label163" runat="server" Font-Bold="True" ForeColor="Red" 
                    Text="Note :  Student ID, Admission Date, Application No., Application Date  can't be changed due to Security Reasons...!"></asp:Label>
                <br />
        ...
        Height="25px" Width="400px" PlaceHolder="Enter Your E-Mail" TextMode="Email"></asp:TextBox>
        ...
        Height="25px" Width="400px" PlaceHolder="Enter Your Mobile Number" TextMode="Phone"></asp:TextBox>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Height="25px" Width="400px" PlaceHolder="Enter Occupation of Your Father / Spouse "></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" 
                    ControlToValidate="TextBox14" CssClass="validation-style" 
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator12" 
                    ...
                    Display="Dynamic" ErrorMessage="* Please Enter Characters Only" 
                    SetFocusOnError="True" ValidationExpression="[a-zA-Z]+" ValidationGroup="Apply"></asp:RegularExpressionValidator>
                <br />
                ...
                <asp:TextBox ID="TextBox21" runat="server" CssClass="textbox-style" 
                    Height="25px" PlaceHolder="Enter Pin Code (Upto 6 Digits)" Width="400px"></asp:TextBox>
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Label ID="Label39" runat="server" CssClass="heading-style" 
                    Text="Course &amp; Semester "></asp:Label>
                ...
                <br />
                <br />
                <asp:Label ID="Label161" runat="server" Font-Bold="True" ForeColor="Red" 
                    Text="Note : Fields Given Below can't be changed due to Security Reasons...!"></asp:Label>
                <br />
                <br />
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                <asp:Panel ID="Panel19" runat="server" Height="136px">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label162" runat="server" Font-Bold="True" ForeColor="Red" 
                        Text="Note : Field Given Below can't be changed due to Security Reasons...!"></asp:Label>
                    <br />
                    <br />
...
&nbsp;<asp:Label ID="Label119" runat="server" CssClass="label-style" Text="Year of Passing :"></asp:Label>
                ...
                <asp:Panel ID="Panel8" runat="server" Height="371px">
                    ...
                    Width="200px" />--%><br /><br /><br /><br /><br /><br /><br /><br /><br /></asp:Panel>
                <br />
                <asp:Panel ID="Panel10" runat="server" Height="239px">
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:TextBox ID="TextBox71" runat="server" CssClass="textbox-style" 
                        Height="25px" Width="400px" PlaceHolder="Enter Security Answer"></asp:TextBox>
                    <br />
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:Button 
                    ...
                    CssClass="button-style" Height="33px" 
                    onclick="Button12_Click" Text="Update Student's Data" Width="220px" 
