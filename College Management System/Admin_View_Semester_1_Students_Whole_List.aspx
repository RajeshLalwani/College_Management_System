<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="Admin_View_Semester_1_Students_Whole_List.aspx.cs" Inherits="Admin_View_Semester_1_Students_Whole_List" %>
...
<br />
    ...
    SelectCommand="SELECT * FROM [Student_Details] WHERE (([StdAStatus] = @StdAStatus) AND ([StdASemester] = @StdASemester))">
        <SelectParameters>
            ...
            <asp:Parameter DefaultValue="Semester 1" Name="StdASemester" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
