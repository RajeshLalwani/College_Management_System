...
public partial class Admin_Delete_Students_Whole_List : System.Web.UI.Page
{
    ...
    {
        if (e.CommandName == "Delete Details")
        {
            Response.Redirect("Admin_Delete_Students_Individual_List.aspx?StdAdmissionID=" + e.CommandArgument.ToString());
        }
    }
}