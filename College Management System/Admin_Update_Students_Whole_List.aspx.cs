...
public partial class Admin_Update_Students_Whole_List : System.Web.UI.Page
{
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("Admin_Update_Students_Individual_List.aspx?StdAdmissionID=" + e.CommandArgument.ToString());
        }
    }
}